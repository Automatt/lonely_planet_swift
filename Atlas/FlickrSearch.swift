...
//  flickrSearch
//
//  Created by Mathew Spolin on 4/4/2015.
...
let apiKey = "9e47767eaac13f88691f8e3eb47c7bd7"
...
class Flickr {
  ...
  private func flickrSearchURLForSearchTerm(searchTerm:String) -> NSURL {
    ...
    let URLString = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(apiKey)&text=\(escapedTerm)&per_page=20&sort=relevance&format=json&nojsoncallback=1"
